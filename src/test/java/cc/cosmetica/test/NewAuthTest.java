...
public class NewAuthTest {
	public static void main(String[] args) throws Exception {
		...
		if (uploadModel) { // NOTE: Will respond by throwing the error "error: duplicate" if the upload is successful as the model is already a cosmetic on the server.
			...
			api.uploadModel(CosmeticType.HAT, "Fez (JCA Test, Don't Approve)", fezTexture, JsonParser.parseString(fezJason).getAsJsonObject()).get();
		}
	}
}
